...
@section('content')
    <div class="card card-red">
        <div class="card-header">
            <h3 class="card-title">Liking Task Create</h3>
        </div>
        <div class="card-body">
            <form class="form" method="get" action="{{ route('liking-tasks.create') }}">
                <div class="row" style="line-height: 60px">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-danger btn-flat" style="width: 100%" type="submit">
            ...
            <form method="post" action="{{ route('liking-tasks.store') }}">
                @csrf
                <div class="card-body">
                    ...
                    <x-adminlte-button class="btn-flat" type="submit" label="Save" theme="danger"
                                       icon="fas fa fa-save"/>
                </div>
            </form>
        </div>
