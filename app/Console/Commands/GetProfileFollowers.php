...
class GetProfileFollowers extends Command
{
    ...
    public function handle(): void
    {
        ...
        foreach ($getFollowersTask as $task) {
            ...
            $this->curlGetFollowersRequest($profileIdToGetFollowers, $personalProfile);
     ...
     * @throws Exception
     */
    public function curlGetFollowersRequest(int $profileIdToGetFollowers, ?Profile $personalProfile): void // move to request
    {
        if(!$personalProfile) {
    ...
    private function saveFollowers($users, $profileid): void //move to repository
    {
        foreach ($users as $user) {
            ...
            $profileFollowers = ProfileFollowers::updateOrCreate(
                [
