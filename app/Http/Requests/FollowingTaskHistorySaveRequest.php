...
class FollowingTaskHistorySaveRequest extends FormRequest
{
    ...
    {
        return [
            'following_task_id' => self::INTEGER,
            ...
            'pause_before_following_started' => self::REQUIRED_100,
            'pause_before_following_finished' => self::REQUIRED_100,
            'following_button_click_time' => self::REQUIRED_100,
            'pause_after_following_started' => self::REQUIRED_100,
            'pause_after_following_finished' => self::REQUIRED_100,
